...
{
    [DbContext(typeof(AbpResearchWorkerDbContext))]
    [Migration("20251106040957_AddJobExtractionFields")]
    partial class AddJobExtractionFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbpResearchWorker.JobDescriptions.InterviewQuestion", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<string>("InterviewerTips")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SkillsEvaluated")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("JobDescriptionId", "Order");

                    b.ToTable("AppInterviewQuestions", (string)null);
                });

            modelBuilder.Entity("AbpResearchWorker.JobDescriptions.JobDescription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CompanyInsights")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("CountryCode", "Language");

                    b.HasIndex("InputType", "SourceDomain");

                    b.HasIndex("Status", "CreationTime");

                    b.ToTable("AppJobDescriptions", (string)null);
                });
            ...
            modelBuilder.Entity("AbpResearchWorker.JobDescriptions.InterviewQuestion", b =>
                {
                    b.HasOne("AbpResearchWorker.JobDescriptions.JobDescription", "JobDescription")
                        .WithMany("Questions")
