...
public class AbpResearchWorkerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AbpResearchWorkerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
